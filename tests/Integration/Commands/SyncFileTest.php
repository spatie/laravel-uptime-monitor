...
class SyncFileTest extends TestCase
{
    ...
    public function it_can_create_monitors()
    {
        ...
        $this->seeInConsoleOutput(Artisan::output(), 'Synced 2 monitor(s) to database');
    ...
    public function it_can_update_existing_monitors()
    {
        ...
        $this->seeInConsoleOutput(Artisan::output(), 'Synced 1 monitor(s) to database');
    ...
    public function it_can_delete_monitors_not_found_in_file()
    {
        ...
        $this->seeInConsoleOutput(Artisan::output(), 'Deleted monitor for `https://www.example.com`');
